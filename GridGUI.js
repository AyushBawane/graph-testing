class GridGUI extends GUI {
    ...
    constructor (container, mapText) {
        ...
        // configuration used by the search algorithm
        this.config = {};
        this.config.actions = [[0, 1], [0, -1], [1, 0], [-1, 0]];   // 4 cardinal directions
        this.config.actionCosts = [100, 100, 100, 100];             // each action costs 100
        this.config.strategy = 'bfs';                               // by default choose BFS
    ...
    setHTML() {
        ...
        this.addSelectBox(this.controlDiv, 'selectalgorithm', 150, top + skip, 250, 25, function() { this.gui.setAlgorithm(); }, 
            [['studentBFS', 'Student BFS'], ['studentDFS', 'Student DFS'], ['bfs', 'Solution BFS'], ['dfs', 'Solution DFS']]);
        ...
        this.addButton(this.controlDiv, 'StepButton', 425, top + 4*skip, 125, 25, "Single Step",         function () { this.gui.step = true; })

        this.disableElemments(['objectsize', 'legalactions']);
...
let tableHeader = "<table rules='all' width='400px'><tr><th>Test </th><th>Start</th><th>Goal</th><th colspan=2>Solution<br>Path</th><th colspan=2>Student<br>Path</th></tr>";
let tableRows = "";
let tableEnd = "";
